...
var font_style = document.createElement("style");
    font_style.type = 'text/css';
        font_style.innerHTML = "*:not(.fa):not(.fas):not(i):not(.glyphicon):not(.material-icons):not(.iconfont):not(.cmn-icon):not(.icon) {font-family: 'PingFang SC', 'FontAwesome'，'sans-serif'  !important; text-shadow:1px 1px 3px #998686;}";
